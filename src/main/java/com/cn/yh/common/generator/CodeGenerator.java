package com.cn.yh.common.generator;
...
public class CodeGenerator {
    ...
    // 数据库 URL
    private static final String URL = "jdbc:sqlserver://119.23.243.224:1433;DatabaseName=Demo";
    // 数据库驱动
    private static final String DRIVER_NAME = "com.microsoft.sqlserver.jdbc.SQLServerDriver";
    // 数据库用户名
    private static final String USERNAME = "sa";
    // 数据库密码
    private static final String PASSWORD = "HByh1234#";
    // @author 值
    private static final String AUTHOR = "Mr.Wang";
    // 包的基础路径
    private static final String BASE_PACKAGE_URL = "com.cn.yh";
    // xml文件路径
